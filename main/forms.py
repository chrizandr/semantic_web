...
class Data_type_form(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for ontoclass in class_list:
            self.fields['custom_q%s' % ontoclass ] = forms.CharField(label="break",help_text="new_set")
            ...
            for prop in dprop_object[ontoclass]:
                ...
                if prop_range=='integer':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.IntegerField(label=prop_name,help_text="Data Property",widget = forms.NumberInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='string':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.CharField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='boolean':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.BooleanField(label=prop_name,help_text="Data Property")
                elif prop_range=='decimal':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.DecimalField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='float':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.FloatField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='double':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.DecimalField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='duration':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.DurationField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='dateTime':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.DateTimeField(label=prop_name,help_text="Data Property",widget=forms.SelectDateWidget(empty_label="Nothing"))
                elif prop_range=='time':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.TimeField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='date':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.DateField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
                elif prop_range=='anyURI':
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.URLField(label=prop_name,help_text="Data Property",widget = forms.URLInput(attrs={ 'placeholder': 'Data Property'}))
                else:
                    self.fields['d_%s_%s' % (prop_range, prop_name) ] = forms.CharField(label=prop_name,help_text="Data Property",widget = forms.TextInput(attrs={ 'placeholder': 'Data Property'}))
    #-----------------------------------------------------------------
